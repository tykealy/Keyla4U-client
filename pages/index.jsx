...
export default function Home() {
  ...
  const data = [
    { title: 'football', description: 'This is card 1' ,image: 'Football.jpeg' },
    { title: 'volleyball', description: 'This is card 2' ,image: 'Volleyball.jpeg'},
    { title: 'golf', description: 'This is card 3' ,image: 'Golf.jpeg'},
    { title: 'basketball', description: 'This is card 4' ,image: 'Basketball.jpeg'},
